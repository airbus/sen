...
class SenConan(ConanFile):
    ...
    def validate(self):
        ...
        if self._is_component_enabled("web_explorer") and not self._is_component_enabled("jsonrpc"):
            raise ConanInvalidConfiguration(
                "with_web_explorer requires with_jsonrpc (web_explorer/backend links " "against the jsonrpc component)."
            )
