...
# Written into the checkout by the docs build and gitignored, so a clean tree never
# has them. Naming one is legitimate; requiring it to be on disk is not.
