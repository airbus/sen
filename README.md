...
Open an [issue](https://github.com/airbus/sen/issues) if you hit a problem, and always consult the [docs](https://airbus.github.io/sen/latest/) for the latest guidance.
