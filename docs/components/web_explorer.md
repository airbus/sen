...
one-page mental model is at `components/web_explorer/frontend/architecture.md` in the
repo, alongside per-side READMEs at `components/web_explorer/{frontend,backend}/README.md`.
