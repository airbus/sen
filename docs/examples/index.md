...
Read [Mental Model](../users_guide/mental_model.md) and [Main Concepts](../users_guide/main_concepts.md).
...
- [Command Line reference](../users_guide/command_line.md) - `sen run`, `sen shell`, YAML config schema
