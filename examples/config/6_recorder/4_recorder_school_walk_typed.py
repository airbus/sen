...
try:
    ...
    print(f"Property writes seen across {len(property_changes_by_object)} objects " f"(top 5):")
    ...
    print(f"Events fired ({sum(events_seen.values())} total across " f"{len(events_seen)} (object, event) pairs):")
