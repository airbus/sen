...
`add_sen_package`. It is a JSON object whose keys are method names and whose values are modifier objects.
...
OBJECT target, not to `fibonacci` or `fibonacci_test` directly (see the [CMake
documentation](../../users_guide/cmake.md) for details).
