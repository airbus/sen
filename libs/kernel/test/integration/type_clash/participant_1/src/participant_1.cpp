...
void App1ClassImpl::registered(sen::kernel::RegistrationApi& api)
{
...
void App1ClassImpl::shutdownKernelImpl()
{
  if (kernelApiObj_)
  {
...
SEN_EXPORT_CLASS(App1ClassImpl)
