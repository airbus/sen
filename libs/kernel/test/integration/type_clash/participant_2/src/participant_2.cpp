...
void App2ClassImpl::registered(sen::kernel::RegistrationApi& api)
{
...
void App2ClassImpl::shutdownKernelImpl()
{
  if (kernelApiObj_)
  {
...
SEN_EXPORT_CLASS(App2ClassImpl)
