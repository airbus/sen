...
protected:  // TestClassBase
  TestEnum testMethodImpl(const runtime::TestSequence2& arg1,
                          const runtime::TestStructBase& arg3,
                          const runtime::TestVariant& arg2) override;
...
#endif  // SEN_LIBS_KERNEL_TEST_INTEGRATION_RUNTIME_COMPATIBILITY_RUNTIME_6_SRC_RUNTIME_H
