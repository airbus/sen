...
#ifndef SEN_LIBS_KERNEL_TEST_INTEGRATION_TRANSPORT_TRANSPORT_1_SRC_TRANSPORT_H
#define SEN_LIBS_KERNEL_TEST_INTEGRATION_TRANSPORT_TRANSPORT_1_SRC_TRANSPORT_H
...
#endif  // SEN_LIBS_KERNEL_TEST_INTEGRATION_TRANSPORT_TRANSPORT_1_SRC_TRANSPORT_H
